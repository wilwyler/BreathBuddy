...
public class restHappyLogic : MonoBehaviour
{
    ...
    public void TakeBreath(int selection)
    {
        ...
        {
            Debug.Log("Poorer Breath"); 
            health_points += 15;
        } else if (selection == 3)
        {
            Debug.Log("Poor Breath"); 
            health_points += 20;
        }
        else if (selection == 4)
        {
            Debug.Log("Good Breath"); 
            health_points += 25;
        }
        else if (selection == 5)
        {
            Debug.Log("Better Breath"); 
            health_points += 30;
        }
        else if (selection == 6)
        {
            Debug.Log("Best breath"); 
            health_points += 35;
        }
